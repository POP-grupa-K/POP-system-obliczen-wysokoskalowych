...
const AppStoreLink = () => (
  <NavDrawerLink name="App Store"><StoreIcon/></NavDrawerLink>
)

const DataShelfLink = () => (
  <NavDrawerLink name="Data Shelf"><SaveIcon/></NavDrawerLink>
)

const ComputationCockpitLink = () => (
  <NavDrawerLink name="Computation Cockpit"><ComputerIcon/></NavDrawerLink>
)
